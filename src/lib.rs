...
#[derive(Debug)]
pub struct HushBeaconProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HushBeaconProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HushBeacon processing");
    
    let mut processor = HushBeaconProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HushBeaconProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HushBeaconProcessor::new(false);
